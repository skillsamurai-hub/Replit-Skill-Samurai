    ...
    <section className="py-16 md:py-24 bg-secondary relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        <FadeIn className="max-w-5xl mx-auto relative">
          ...
          <div className="relative bg-white text-secondary border-[3px] border-secondary/10 rounded-[2rem] md:rounded-[2.5rem] p-6 sm:p-8 md:p-14 shadow-2xl shadow-secondary/25 text-center">
