      ...
      <div className="container mx-auto px-4 relative z-10 pt-20 sm:pt-24 lg:pt-32 pb-8 min-h-[78svh] md:min-h-[calc(100svh-16rem)] flex items-center justify-center">
        <div className="max-w-4xl text-center mx-auto flex flex-col items-center pb-4 lg:pb-8">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-white/90 mb-6 lg:mb-8 leading-relaxed font-medium drop-shadow max-w-2xl mx-auto">
            <span className="block">We help kids build confidence, creativity, and future-ready skills</span>
            <span className="block">by creating technology — instead of just consuming it.</span>
          </p>
