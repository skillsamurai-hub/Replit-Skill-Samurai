...
const cards = [
  {
    ...
    tag: "3D Designer",
    quote:
      "I never thought I'd be able to build something that actually looked real. When I showed everyone, I couldn't stop smiling.",
    Icon: Palette,
    color: "text-primary",
    bg: "bg-primary/10",
  ...
  },
  {
    ...
    tag: "3D Designer",
    quote: "I sketched it out in my head and then just built it. It actually came out the way I imagined.",
    Icon: Code2,
    color: "text-[#F59100]",
    bg: "bg-[#F59100]/10",
  ...
  },
  {
    ...
    tag: "Game Creator",
    quote: "My frog can jump over anything. I made all the levels myself!",
    Icon: Gamepad2,
    color: "text-primary",
    bg: "bg-primary/10",
    border: "border-primary/20",
  ...
  },
  {
    ...
    tag: "Game Creator",
    quote: "I didn't know anything about coding before. Now I built an actual game. That's crazy to me.",
    Icon: Gamepad2,
