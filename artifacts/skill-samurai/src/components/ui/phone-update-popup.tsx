...
export default function PhoneUpdatePopup() {
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-[9999] flex items-end sm:items-center justify-center sm:p-4 transition-opacity duration-300"
    ...
    >
      ...
      <div
        className="relative z-10 w-full sm:max-w-lg rounded-t-3xl sm:rounded-3xl bg-white shadow-2xl overflow-hidden transition-all duration-300 max-h-[92dvh] flex flex-col"
        style={{
      ...
      >
        ...
        <div className="overflow-y-auto flex-1">
          {/* ── Header (navy) ── */}
          <div className="bg-secondary px-5 sm:px-6 pt-4 sm:pt-5 pb-5 sm:pb-6">
            <div className="flex items-start justify-between gap-3 mb-3">
              <div className="flex items-center gap-3">
                <div className="flex h-9 w-9 sm:h-10 sm:w-10 shrink-0 items-center justify-center rounded-full bg-primary/20">
                  <Phone className="h-4 w-4 sm:h-5 sm:w-5 text-primary" />
                </div>
                <div>
                  <p className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-primary mb-0.5">
                    Important Update
                  </p>
                  <h2
                    id="ss-phone-popup-title"
                    className="text-base sm:text-lg font-extrabold text-white leading-tight font-heading"
                  >
            ...
            <p id="ss-phone-popup-desc" className="text-xs sm:text-sm text-white/70 leading-relaxed">
          ...
          <div className="px-5 sm:px-6 py-5 sm:py-6 flex flex-col gap-4">
            ...
            {/* Phone number card */}
            <div className="rounded-2xl border-2 border-border bg-muted/40 px-4 sm:px-5 py-3 sm:py-4">
              <p className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-muted-foreground mb-1">
                Our New Direct Number
              </p>
              <p className="text-3xl sm:text-4xl font-black text-primary font-heading tracking-tight">
                (431) 998-2155
              </p>
            </div>
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 rounded-xl border-2 border-primary/30 bg-primary/5 px-5 py-3 text-sm font-semibold text-primary transition-colors hover:bg-primary/10 hover:border-primary/50"
            >
            ...
            <div className="flex gap-3">
              ...
              <a
                ...
                className="flex flex-1 items-center justify-center gap-2 rounded-xl border-2 border-border px-4 py-3.5 text-sm font-semibold text-secondary transition-colors hover:border-primary hover:text-primary"
              >
            ...
            {/* Footer note */}
            <p className="text-center text-xs text-muted-foreground leading-relaxed pb-1">
