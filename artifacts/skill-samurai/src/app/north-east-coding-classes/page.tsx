...
export const metadata: Metadata = {
  title: "North East Coding Classes — Register | Skill Samurai Winnipeg",
  description:
    "Register for weekly coding, robotics, and STEM classes at our North East Winnipeg location. Ages 6–18. Classes run Monday & Tuesday evenings at 1199 Rothesay St.",
  alternates: {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex flex-wrap items-start gap-6 md:gap-10">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-white/70 text-base md:text-lg max-w-xl">
                Register your child for weekly coding, robotics, and STEM classes at our North East location. Ages 6–18. No experience needed.
              </p>
            </div>
            <div className="flex flex-col gap-3 shrink-0">
              <div className="flex items-start gap-3 bg-white/10 rounded-xl px-4 py-3">
                ...
                <div>
                  <p className="text-white font-semibold text-sm">1199 Rothesay St.</p>
                  <p className="text-white/60 text-xs">Winnipeg, MB R2G 1T6</p>
                </div>
              </div>
              <div className="flex items-start gap-3 bg-white/10 rounded-xl px-4 py-3">
                <Clock className="h-4 w-4 text-primary mt-0.5 shrink-0" />
                <div>
                  <p className="text-white font-semibold text-sm">Mon &amp; Tue · 5:30pm &amp; 6:30pm</p>
      ...
      <div className="w-full bg-gray-50">
        <iframe
          src="https://winnipeg.jumbula.com/north-east-coding-classes"
          title="North East Coding Classes — Registration"
