...
export const metadata: Metadata = {
  title: "Seven Oaks Coding Classes — Register | Skill Samurai Winnipeg",
  description:
    "Register for weekly coding, robotics, and STEM classes at our Seven Oaks Winnipeg location. Ages 6–18. Classes run Wednesday & Thursday evenings at 745 Kingsbury Ave.",
  alternates: {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex flex-wrap items-start gap-6 md:gap-10">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-white/70 text-base md:text-lg max-w-xl">
                Register your child for weekly coding, robotics, and STEM classes at our Seven Oaks location. Ages 6–18. No experience needed.
              </p>
            </div>
            <div className="flex flex-col gap-3 shrink-0">
              <div className="flex items-start gap-3 bg-white/10 rounded-xl px-4 py-3">
                ...
                <div>
                  <p className="text-white font-semibold text-sm">745 Kingsbury Ave.</p>
                  <p className="text-white/60 text-xs">Winnipeg, MB R2V 3N5</p>
                </div>
              </div>
              <div className="flex items-start gap-3 bg-white/10 rounded-xl px-4 py-3">
                <Clock className="h-4 w-4 text-primary mt-0.5 shrink-0" />
                <div>
                  <p className="text-white font-semibold text-sm">Wed &amp; Thu · 4:30, 5:30 &amp; 6:30pm</p>
                  <p className="text-white/60 text-xs">Weekly after-school classes</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="w-full bg-gray-50">
        <iframe
          src="https://winnipeg.jumbula.com/seven-oaks-coding-classes"
          title="Seven Oaks Coding Classes — Registration"
