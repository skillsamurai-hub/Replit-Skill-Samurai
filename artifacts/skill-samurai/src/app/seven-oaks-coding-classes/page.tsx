    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-secondary relative overflow-hidden py-16 md:py-24">
        ...
        <div className="container mx-auto px-4 max-w-5xl relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              <p className="text-primary font-bold uppercase tracking-widest text-xs mb-3">Seven Oaks · 745 Kingsbury Ave.</p>
              ...
              <div className="flex flex-wrap gap-3 mb-6 text-sm">
                <span className="flex items-center gap-1.5 text-white/80 font-medium"><MapPin className="h-3.5 w-3.5 text-primary" />745 Kingsbury Ave.</span>
                <span className="flex items-center gap-1.5 text-white/80 font-medium"><Clock className="h-3.5 w-3.5 text-primary" />Wed &amp; Thu · 4:30, 5:30 &amp; 6:30pm</span>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="text-center">
            ...
            >
              Enroll at Seven Oaks <ArrowRight className="h-4 w-4" />
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <h2 className="text-3xl md:text-4xl font-black font-heading text-secondary text-center mb-10 tracking-tight">Seven Oaks — 745 Kingsbury Ave.</h2>
          <div className="grid sm:grid-cols-2 gap-5">
            <div className="bg-gray-50 border border-gray-100 rounded-3xl p-6">
              <MapPin className="h-6 w-6 text-primary mb-3" />
              <p className="text-xs font-bold uppercase tracking-wider text-secondary/50 mb-1">Address</p>
              <p className="text-secondary font-black text-xl mb-1">745 Kingsbury Ave.</p>
              <p className="text-secondary/60 text-sm mb-4">Winnipeg, MB R2V 3N5</p>
              <a href="https://www.google.com/maps/place/Skill+Samurai+-+Coding,+Robotics+%26+STEM+Academy+(Coding+For+Kids+in+Winnipeg)/@49.9482295,-97.1417296,17z" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-primary text-sm font-bold hover:underline">
            ...
            <div className="bg-gray-50 border border-gray-100 rounded-3xl p-6">
              ...
              <p className="text-secondary font-black text-xl mb-1">Wednesday &amp; Thursday</p>
              <p className="text-secondary/70 text-sm mb-1">4:30 PM, 5:30 PM &amp; 6:30 PM</p>
              <p className="text-secondary/50 text-xs">Year-round · Weekly · 55 minutes</p>
            </div>
            <div className="bg-gray-50 border border-gray-100 rounded-3xl p-6">
      ...
      <section className="py-16 bg-secondary border-t border-white/5">
        <div className="container mx-auto px-4 max-w-2xl text-center">
          ...
          >
            Enroll at Seven Oaks <ArrowRight className="h-5 w-5" />
          </a>
