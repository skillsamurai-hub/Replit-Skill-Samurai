...
export const metadata: Metadata = {
  title: "Seven Oaks Coding Classes for Kids | Skill Samurai Winnipeg",
  description:
    "Weekly coding, robotics, and STEM classes for kids ages 6–18 at our Seven Oaks Winnipeg location. 745 Kingsbury Ave. Wednesday & Thursday evenings. Book a free trial class.",
  alternates: {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-secondary relative overflow-hidden py-16 md:py-24">
        ...
        <div className="container mx-auto px-4 max-w-5xl relative z-10">
          ...
          <p className="text-primary font-bold uppercase tracking-widest text-xs mb-3">Skill Samurai Winnipeg — Seven Oaks</p>
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black font-heading text-white leading-tight tracking-tight mb-5">
            Seven Oaks<br />Coding Classes
          </h1>
          ...
          <div className="flex flex-wrap gap-4">
            <div className="flex items-center gap-2 bg-white/10 rounded-xl px-4 py-2.5">
              ...
              <span className="text-white text-sm font-semibold">745 Kingsbury Ave., Winnipeg</span>
            </div>
            <div className="flex items-center gap-2 bg-white/10 rounded-xl px-4 py-2.5">
              <Clock className="h-4 w-4 text-primary shrink-0" />
              <span className="text-white text-sm font-semibold">Wed &amp; Thu · 4:30, 5:30 &amp; 6:30pm</span>
            </div>
            <div className="flex items-center gap-2 bg-white/10 rounded-xl px-4 py-2.5">
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <h2 className="text-3xl md:text-4xl font-black font-heading text-secondary text-center mb-3 tracking-tight">Programs at Seven Oaks</h2>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <h2 className="text-3xl md:text-4xl font-black font-heading text-secondary text-center mb-10 tracking-tight">Seven Oaks Location Details</h2>
          <div className="grid sm:grid-cols-2 gap-5">
            <div className="bg-gray-50 border border-gray-100 rounded-3xl p-6">
              ...
              <p className="text-secondary font-black text-lg leading-snug mb-1">745 Kingsbury Ave.</p>
              <p className="text-secondary/60 text-sm mb-3">Winnipeg, MB R2V 3N5</p>
              <a
                href="https://www.google.com/maps/place/Skill+Samurai+-+Coding,+Robotics+%26+STEM+Academy+(Coding+For+Kids+in+Winnipeg)/@49.9482295,-97.1417296,17z"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div className="bg-gray-50 border border-gray-100 rounded-3xl p-6">
              ...
              <p className="text-secondary font-black text-lg leading-snug mb-1">Wednesday &amp; Thursday</p>
              <p className="text-secondary/70 text-sm mb-1">4:30 PM, 5:30 PM &amp; 6:30 PM</p>
      ...
      <section className="py-16 bg-gray-50 border-t border-gray-100">
        <div className="container mx-auto px-4 max-w-3xl text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-black font-heading text-secondary mb-4 tracking-tight">Ready to enroll at Seven Oaks?</h2>
