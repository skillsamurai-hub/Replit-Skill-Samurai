...
export const metadata: Metadata = {
  title: "St. Alphonsus Coding Classes for Kids | Skill Samurai Winnipeg",
  description:
    "Weekly coding, robotics, and STEM classes for kids ages 6–18 at our St. Alphonsus location in Winnipeg. No experience needed. Book a free trial class today.",
  alternates: {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-secondary relative overflow-hidden py-16 md:py-24">
        ...
        <div className="container mx-auto px-4 max-w-5xl relative z-10">
          ...
          <p className="text-primary font-bold uppercase tracking-widest text-xs mb-3">Skill Samurai Winnipeg — St. Alphonsus</p>
          ...
          <div className="flex flex-wrap gap-3 mb-10">
            <a
              href="https://book.skillsamuraiwinnipeg.com"
              target="_blank"
          ...
          <div className="flex flex-wrap gap-4">
            <div className="flex items-center gap-2 bg-white/10 rounded-xl px-4 py-2.5">
              ...
              <span className="text-white text-sm font-semibold">St. Alphonsus School, Winnipeg</span>
            </div>
            <div className="flex items-center gap-2 bg-white/10 rounded-xl px-4 py-2.5">
              <Clock className="h-4 w-4 text-primary shrink-0" />
              <span className="text-white text-sm font-semibold">After-school weekly classes</span>
            </div>
            <div className="flex items-center gap-2 bg-white/10 rounded-xl px-4 py-2.5">
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <h2 className="text-3xl md:text-4xl font-black font-heading text-secondary text-center mb-3 tracking-tight">Programs at St. Alphonsus</h2>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            <div className="bg-gray-50 border border-gray-100 rounded-3xl p-6">
              ...
              <p className="text-secondary font-black text-lg leading-snug mb-1">St. Alphonsus School</p>
              <p className="text-secondary/60 text-sm mb-3">Winnipeg, MB</p>
              <a
                href="https://maps.google.com/?q=St+Alphonsus+School+Winnipeg"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div className="bg-gray-50 border border-gray-100 rounded-3xl p-6">
              ...
              <p className="text-secondary font-black text-lg leading-snug mb-1">After-school weekly classes</p>
              <p className="text-secondary/50 text-xs font-medium">See registration form for current schedule</p>
            </div>
            <div className="bg-gray-50 border border-gray-100 rounded-3xl p-6">
              <div className="h-10 w-10 rounded-xl bg-primary/10 flex items-center justify-center mb-4">
      ...
      <section className="py-16 bg-gray-50 border-t border-gray-100">
        <div className="container mx-auto px-4 max-w-3xl text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-black font-heading text-secondary mb-4 tracking-tight">Ready to enroll at St. Alphonsus?</h2>
